...
--------------------------
The raw data for this project was obtained using the following url:
http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones 
The data was recorded from a group of 30 volunteers doing six activities
...
----------------------------------
 ...
 4. The output file "finalFile.txt" will be available in your working directory
